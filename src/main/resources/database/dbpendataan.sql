...
CREATE TABLE `penduduk` (
  ...
  `status_ekonomi` varchar(255) DEFAULT NULL,
...
INSERT INTO `penduduk` VALUES (1,'KOMPLEK MUSTIKA WANASARI BLOK C8 NO. 59 CIBITUNG BEKASI','WIWIT SETYO PUTRO',NULL,812813297,NULL,'JAKARTA','B','LAKI_LAKI','INDONESIA','S1','LULUS','MENIKAH',NULL,NULL,NULL),(2,'PERUMAHAN SAKINAH 4 CIKARANG BARAT BEKASI','BUDI SUTRISNO',NULL,811288370,NULL,'JAKARTA','B','LAKI_LAKI','INDONESIA','SMK','LULUS','MENIKAH',NULL,NULL,NULL),(4,'PEKAYON JAYA','NUNIK',NULL,812813297,NULL,'JAKARTA','B','PEREMPUAN','INDONESIA','SMU','LULUS','MENIKAH','SWASTA',3600000,'SEDERHANA');
...
-- Dump completed on 2019-10-23 20:51:26
