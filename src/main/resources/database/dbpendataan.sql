...
INSERT INTO `penduduk` VALUES (1,'KOMPLEK MUSTIKA WANASARI BLOK C8 NO. 59 CIBITUNG BEKASI','WIWIT SETYO PUTRO',NULL,812813297,'SWASTA',NULL,'JAKARTA','B','LAKI_LAKI','INDONESIA','S1','LULUS','MENIKAH'),(2,'PERUMAHAN SAKINAH 4 CIKARANG BARAT BEKASI','BUDI SUTRISNO',NULL,811288370,'SWASTA',NULL,'JAKARTA','B','LAKI_LAKI','INDONESIA','SMK','LULUS','MENIKAH'),(4,'PEKAYON JAYA','NUNIK',NULL,812813297,'SWASTA',NULL,'JAKARTA','B','PEREMPUAN','INDONESIA','SMU','LULUS','MENIKAH');
...
-- Dump completed on 2019-10-21 16:16:15
